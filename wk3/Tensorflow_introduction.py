...
def compute_cost(logits, labels):
    ...
    # cost = ...
    # YOUR CODE STARTS HERE
    #for this exercise => logits.shape = labels.shape = (6, num_of_examples)
    #but, tf.keras.losses.categorical_crossentropy expects the shape to be (num_of_examples, num_of_classes = 6)
    #need to transpose both logits and labels
